...
export const Layout = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Navigation */}
      <nav className="bg-black/20 backdrop-blur-md border-b border-white/10 fixed top-0 left-0 right-0 z-50">
          ...
          <div className="flex justify-between items-center h-20">
                ...
                {navItems.map((item) => (
                  <NavLink
                    ...
                    className={cn(
                      ...
                      isActive(item.path)
                        ? "text-brand-classic-gold border-b-2 border-brand-classic-gold"
                        : "text-white hover:text-brand-classic-gold"
                    )}
                  >
                    {item.name}
                  </NavLink>
            ...
            <div className="hidden lg:flex items-center space-x-4">
              <a
                ...
                className="flex items-center space-x-2 text-sm text-white/80 hover:text-brand-classic-gold transition-colors"
              >
              ...
              {navItems.map((item) => (
                <NavLink
                  ...
                  className={cn(
                    ...
                    isActive(item.path)
                      ? "text-brand-classic-gold bg-white/10"
                      : "text-white hover:text-brand-classic-gold hover:bg-white/10"
                  )}
                >
                  {item.name}
                </NavLink>
