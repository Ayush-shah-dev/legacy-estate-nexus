          ...
          <div className="flex justify-between items-center h-22">
            ...
            <div className="hidden lg:flex items-center space-x-2">
              ...
              <a
                ...
                className="flex items-center space-x-2 text-sm text-brand-maroon transition-colors"
              >
          ...
          <div className="md:hidden bg-background border-t">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <div>
                ...
                <a
                  href="tel:+919930033056"
                  className="flex items-center space-x-2 pr-2 py-2 text-sm text-muted-foreground"
                >
                <Phone className="h-4 w-4" />
                <span>+91 99300 33056</span>
              </a>
